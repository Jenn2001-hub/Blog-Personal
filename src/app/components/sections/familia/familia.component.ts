...
@Component({
  selector: 'app-familia', //etiqueta HTML que se usa para este componente
  ...
  templateUrl: './familia.component.html', //archivo HTM donde se tengo definida la estructura del componente
  styleUrls: ['./familia.component.scss']// archivo SCSS donde estan los estilos del componente
})
//exporta la logica de este componente
export class FamiliaComponent {
  images = [
    {
      itemImageSrc: 'assets/images/familia1.jpg', //imagen principal
      thumbnailImageSrc: 'assets/images/familia1-thumb.jpg', //imagen miniatura
    },
    {
      itemImageSrc: 'assets/images/familia2.jpg', //imagen principal
      thumbnailImageSrc: 'assets/images/familia2-thumb.jpg', //imagen miniatura
    },
    {
      itemImageSrc: 'assets/images/familia3.jpg', //imagen principal
      thumbnailImageSrc: 'assets/images/familia3-thumb.jpg', //imagen miniatura
    }
  ];
