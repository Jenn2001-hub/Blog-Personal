...
@Component({
  selector: 'app-hobbies', //etiqueta HTML que se usa para este componente
  ...
  templateUrl: './hobbies.component.html', //archivo HTM donde se tengo definida la estructura del componente
  styleUrls: ['./hobbies.component.scss'] // archivo SCSS donde estan los estilos del componente
})
//exporta la logica de este componente
export class HobbiesComponent {
  images = [
    {
      itemImageSrc: 'assets/images/hobbies1.jpg', //imagen principal
      thumbnailImageSrc: 'assets/images/hobbies1-thumb.jpg', //imagen miniatura
    },
    {
      itemImageSrc: 'assets/images/hobbies2.jpg', //imagen principal
      thumbnailImageSrc: 'assets/images/hobbies2-thumb.jpg', //imagen miniatura
    },
    {
      itemImageSrc: 'assets/images/hobbies3.jpg', //imagen principal
      thumbnailImageSrc: 'assets/images/hobbies3-thumb.jpg', //imagen miniatura
    }
  ];
